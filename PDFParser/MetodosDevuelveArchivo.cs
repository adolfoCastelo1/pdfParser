...
namespace PDFParser
{
    public class MetodosDevuelveArchivo
    {
        ...
        private static void ProcesarTxtPagesPershing(string[] paginas, string outputTxtFilePath)
        {
        ...
        private static void ProcesarTxtPagesMorganStanley(string[] paginas, string outputTxtFilePath)
        {
            string retorno = "{ \r\n\"PDF\":\r\n";
            for (int page = 1; page <= paginas.Length - 1; page++)
            {
        ...
        public static string PershingOMorgan(string filePath)
        {
            string text = "";
        ...
        public static void ProcesarPDF(string filePath, string outputFilePath)
        {
            string[] paginas = ArrayPerPdfPage(filePath);
            if (PershingOMorgan(filePath) == "P")
            {
                ProcesarTxtPagesPershing(paginas, outputFilePath);
            }
            else if (PershingOMorgan(filePath) == "M")
            {
                ProcesarTxtPagesMorganStanley(paginas, outputFilePath);
            }
        }
    }
}
